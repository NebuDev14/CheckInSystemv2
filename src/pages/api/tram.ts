...
export default async function handler(
  ...
  rawData.split("\n").forEach(stop => {
    ...
    if ((chunks[0].startsWith("car1_Fri-Sat_Extension_toM") && extraTimes) || (chunks[0].startsWith("car1_Standard_toM"))) times.push(parseInt(chunks[1].slice(0, 2))%24 + chunks[1].slice(2))
  })
